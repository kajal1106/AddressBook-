...
public class StackMainWindow extends JFrame implements ActionListener {
	...
	public StackMainWindow() throws MalformedURLException, RemoteException, NotBoundException {


		String url =  "rmi:///"; 
		StackInterfaceAddressbook a = (StackInterfaceAddressbook) Naming.lookup( url + "Singh" );
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				try {
					Stack<AddressbookNode> l = a.print();

					ObjectOutputStream out=new ObjectOutputStream(
							  new FileOutputStream("Stack"));
					out.writeObject(l);
						System.out.println("Stack Data Generated");
				    	out.close();
		...
		setTitle("Address Book(Stack)");
		setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
		setBounds(100, 100, 981, 621);
		...
		panel_1.setBounds(196, 32, 741, 249);
		contentPane.add(panel_1);

		JPanel utilitiess = new JPanel();
		utilitiess.setBounds(27, 32, 143, 249);
		...
		panel.setBounds(345, 291, 592, 283);
		...
		panel_3.setBounds(27, 291, 308, 283);
...
//				///////////////TABLE
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				StackMainWindow.this.setVisible(false);
		...
		btnNewButton_1.setBounds(862, 7, 61, 21);
		contentPane.add(btnNewButton_1);
	}



	public StackMainWindow(String string) {
