...
import App.App;
import LinkedList.AddressbookException;
import LinkedList.AddressbookNode;
import LinkedList.MainWindow;
import java.awt.event.WindowAdapter;
import java.awt.event.WindowEvent;

public class MainWindowTree extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MainWindowTree frame = new MainWindowTree();
	 ...
	 * @return 
	 */
	TreeSet<AddressbookNode> l = new TreeSet<AddressbookNode>();
	private JTextField maleNum;
	private JTextField searchLname;

	public MainWindowTree() throws MalformedURLException, RemoteException, NotBoundException {
		String url =  "rmi:///"; 
		InterfaceAddressbookTree a = (InterfaceAddressbookTree) Naming.lookup( url + "Singhhhhh" );
		...
		setTitle("Address Book(Tree Set)");
		setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
		setBounds(100, 100, 963, 620);
		...
		panel_1.setBounds(190, 31, 741, 249);
		contentPane.add(panel_1);

		JPanel utilitiess = new JPanel();
		utilitiess.setBounds(27, 31, 143, 249);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(result1==true&&result2==true)
				{
					try {
						...
						a.insert(n);
						TreeSet<AddressbookNode> l = a.print();
						Iterator<AddressbookNode> iterator = l.iterator();
		/////////////////TABLE
								String[] columnnames = {"id","fname","lname","mobile","Gender","address","city","email"};
								DefaultTableModel model = new DefaultTableModel();
								model.setColumnIdentifiers(columnnames);
								table_1.setModel(model);
								Iterator<AddressbookNode> iterator2 = l.iterator();
...
//
		...
		panel.setBounds(345, 290, 592, 283);
		...
		panel_3.setBounds(27, 290, 308, 283);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				MainWindowTree.this.setVisible(false);
				...
				try {
					...
					out.writeObject(l);
						System.out.println("TreeSet Data Generated");
				    	out.close();
		...
		btnNewButton_1.setBounds(870, 8, 61, 21);
		contentPane.add(btnNewButton_1);
	}



	public MainWindowTree(String string) {
